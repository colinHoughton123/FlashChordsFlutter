...
class _ConfigScreenState extends State<ConfigScreen> {
  ...
  void _toggleWithGuard({
    ...
    if (!isChecked && list.length == 1) {
      // trying to uncheck the last one => show message, do nothing
